sap.ui.define([
	...
	return BaseController.extend("com.mjzsoft.FileUploader0Auto.controller.Detail", {
		...
		getFileUploaderObject: function () {
			return this.getView().byId("UploadCollectionPictures");
		},
		...
		getSearchFieldObject: function () {
			return this.getView().byId("searchFilePicturesField");
		}
	});
