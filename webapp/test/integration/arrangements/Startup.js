sap.ui.define([
	"sap/ui/test/Opa5",
	"com/mjzsoft/FileUploader0Auto/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.mjzsoft.FileUploader0Auto.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.mjzsoft.FileUploader0Auto",
					async: true
				},
				hash: oOptions.hash,
